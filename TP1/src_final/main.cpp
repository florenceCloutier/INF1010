...
int main()
{
    ...
    bool resultatLectureFilms = librairie.chargerFilmsDepuisFichier("films.txt", gestionnaireAuteurs);
    bool resultatLectureRestrictions = librairie.chargerRestrictionsDepuisFichiers("restrictionsPays.txt");
    ...
    // On supprime tous les films ajoutés au test 5
