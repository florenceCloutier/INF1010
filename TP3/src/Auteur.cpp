...
///-Construire par defaut un objet de type Auteur
///-Construire par parametre un objet de type Auteur
///-Retourner les attributs de l'objet de type Auteur
///-Changer l'attribut "nbMedias_" de l'objet de type Auteur
...
///-Lire un objet de type Auteur avec une surcharge de l'operateur >>
///
////////////////////////////////////////////////////////////////////////////////
...
//! operateur qui lit un auteur
//! \param is Le stream dans lequel lire
//! \param auteur l'auteur à modifier
//! \return Le stream dans lequel lire
