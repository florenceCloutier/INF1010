...
/// GestionnaireAuteurs et l'implementation des methodes de cette derniere.
///
/// Celles-ci peuvent notamment:
///-Construire par defaut un objet de type GestionnaireAuteurs
///-Chercher un auteur par son nom
///-Charger les auteurs d'un fichier donne
///-Retourner le nombre d'auteurs
///-Ajouter un auteur a la liste d'auteurs avec la surcharge de l'operateur +=
///-Afficher un film avec la surcharge de l'operateur << 
///
////////////////////////////////////////////////////////////////////////////////
